...
namespace EntitiesGenerator.Web.Data.Migrations
{
    ...
    [Migration("20200508110442_IncludeCustomDisplayNames")]
    partial class IncludeCustomDisplayNames
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntitiesGenerator.Item", b =>
                {
                    ...
                    b.Property<bool>("ReverseMappingLiteViewModel")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("EntitiesGenerator.Module", b =>
                {
                    ...
                    b.Property<bool>("IncludeCustomDisplayNames")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("EntitiesGenerator.InterModuleEntityFeatureSetting", b =>
                {
                    b.HasBaseType("EntitiesGenerator.FeatureSetting");

                    b.HasDiscriminator().HasValue("InterModuleEntityFeatureSetting");
                });
            ...
            modelBuilder.Entity("EntitiesGenerator.ManyToManyItemsRelationship", b =>
                {
                    ...
                    b.Property<bool>("HasFullItem1sInItem2ViewModel")
                        .HasColumnType("bit");

                    b.Property<bool>("HasFullItem2sInItem1ViewModel")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("EntitiesGenerator.OneToManyItemsRelationship", b =>
                {
                    ...
                    b.Property<bool>("HasFullChildrenInParentViewModel")
                        .HasColumnType("bit");

                    b.Property<bool>("HasFullParentInChildrenViewModel")
                        .HasColumnType("bit");

                    b.Property<bool>("HasSortedChildrenInParent")
                        .HasColumnType("bit");

                    b.Property<bool>("ParentNullable")
                        .HasColumnType("bit");
